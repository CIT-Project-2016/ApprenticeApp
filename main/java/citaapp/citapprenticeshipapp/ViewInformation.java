...
public class ViewInformation extends AppCompatActivity
{
    ...
    EditText txtUsi, txtCitNum, txtAnpName, txtAnpPhone, txtAnpEmail, txtDeptName, txtDeptPhone, txtDeptEmail, txtLlnDate, txtClassStart;
    ...
    void loadPrefs()
    {
        ...
        try
        {
            ...
            txtLlnDate.setText(preferenceSettings.getString("LLN Date", "01/01/2000"));
            txtClassStart.setText(preferenceSettings.getString("Class Date", "01/01/2000"));
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txtClassStart = (EditText) findViewById(R.id.txtClassStart);
        //not yet implemented

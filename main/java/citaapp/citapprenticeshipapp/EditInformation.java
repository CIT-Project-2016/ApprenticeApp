...
public class EditInformation extends AppCompatActivity {
    ...
    private void saveAllPrefs()
    {
        try
        {
            ...
            saveToPrefs("Class Date", txtClassDate.getText().toString());
    ...
    private void loadPrefs()
    {
        ...
        try {
            ...
            txtLlnDate.setText(preferenceSettings.getString("LLN Date", "01/01/2016"));
            txtClassDate.setText(preferenceSettings.getString("Class Date", "01/01/2016"));
        }
        catch(Exception e)
        {
            Toast.makeText(getApplicationContext(), e.getMessage(), Toast.LENGTH_LONG).show();
